...
describe Transfer do
  ...
  let(:one_account_id) { Account.insert(owner: "one_test_user", bank_id: bank_id, balance: 5000) }
  let(:another_account_id) { Account.insert(owner: "another_test_user", bank_id: bank_id, balance: 8000) }
  let(:third_account_id) { Account.insert(owner: "third_test_user", bank_id: another_bank_id, balance: 1000) }
